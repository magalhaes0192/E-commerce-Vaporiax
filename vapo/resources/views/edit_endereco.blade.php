    ...
    <div class="main">
        <div class="dados-basicos" style="margin-bottom: 30px">
            ...
            <div class="add-enderecos">
                <form action="{{ route('editar-endereco', ['enderecoId' => $endereco->id, 'id' => $user->id]) }}"
                    class="add-dados" method="post"s enctype="multipart/form-data" id="form">
                    @csrf
                    <h3 style="text-align: center; color: white;" id="fechar-h3">Editar endereço</h3>
                    <div class="input-groups">
                        ...
                        <div class="input-group1">
                            <input type="text" name="numero" id="numero"
                                placeholder="Digite o número de sua casa/apto" value="{{ $endereco->numero }}">
                    ...
                    <div class="input-groups">
                        ...
                        <div class="input-group1">
                            <input type="tel" name="cidade" id="cidade" placeholder="Digite seu Cidade"
                    ...
                    <div class="input-groups">
                        <div class="input-group1">
                            <input type="text" name="CEP" id="cep" placeholder="Digite seu CEP"
                                oninput="formatarCep(this)" value="{{ $endereco->CEP }}">
                            <label class="label emai" for="cep">CEP</label>
                        </div>
                        <div class="input-group1">
                            <select id="estado" name="estado">
                                <option value="" disabled selected>{{ $endereco->estado }}</option>
                    ...
                    <div class="input-groups">
                        <div class="input-group1">
                            <select id="endTipo" name="endTipo">
                                <option value="" disabled selected>{{ $endereco->endTipo }}</option>
                        ...
                        <div class="input-group1">
                            <select name="endPadrao" id="endPadrao">
                                <option value="" disabled selected>{{ $endereco->endPadrao }}</option>
                    ...
                    <div class="buttons-form">
                        <button type="submit" class="sumbit-btn" style="width: 100%">EDITAR ENDEREÇO</button>
                    </div>
                </form>
            </div>
        </div>
